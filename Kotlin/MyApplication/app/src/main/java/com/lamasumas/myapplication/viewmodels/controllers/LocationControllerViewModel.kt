package com.lamasumas.myapplication.viewmodels.controllers;
...
import com.lamasumas.myapplication.viewmodels.GeneralViewModel
   ...
   init{
    ...
    fun translateGPS2Place(lon:Double, lat: Double): MylocationObject {
        ...
        geocoder.getFromLocation (lat, lon,3).forEach { address ->
            ...
            System.out.println("Geocoder didn't found anything")
    ...
    override fun preStart(){
        System.out.println("LocationViewModel startted")
